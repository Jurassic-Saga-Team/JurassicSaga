...
<table style={{borderCollapse: "collapse"}}>
  <tr style={{backgroundColor: "transparent"}}>
    <td style={{textAlign: "center"}}>
      <img width={128} src="https://i.imgur.com/placeholder1.png" alt="Chicken Egg"/>
      <div style={{marginTop: "6px", fontSize: "14px", opacity: 0.8}}>
        Chicken Egg
      </div>
    </td>
    <td style={{textAlign: "center"}}>
      <img width={128} src="https://i.imgur.com/placeholder2.png" alt="Frog Egg"/>
      <div style={{marginTop: "6px", fontSize: "14px", opacity: 0.8}}>
        Frog Egg
      </div>
    </td>
    <td style={{textAlign: "center"}}>
      <img width={128} src="https://i.imgur.com/placeholder3.png" alt="Ostrich Egg"/>
      <div style={{marginTop: "6px", fontSize: "14px", opacity: 0.8}}>
        Ostrich Egg
      </div>
    </td>
    <td style={{textAlign: "center"}}>
      <img width={128} src="https://i.imgur.com/placeholder4.png" alt="Fish Egg"/>
      <div style={{marginTop: "6px", fontSize: "14px", opacity: 0.8}}>
        Fish Egg
      </div>
    </td>
  ...
  <tr style={{backgroundColor: "transparent"}}>
    <td style={{textAlign: "center"}}>
      <img width={128} src="https://i.imgur.com/placeholder5.png" alt="Basilisk Egg"/>
      <div style={{marginTop: "6px", fontSize: "14px", opacity: 0.8}}>
        Basilisk Egg
      </div>
    </td>
    <td style={{textAlign: "center"}}>
      <img width={128} src="https://i.imgur.com/placeholder6.png" alt="Spider Egg"/>
      <div style={{marginTop: "6px", fontSize: "14px", opacity: 0.8}}>
        Spider Egg
      </div>
    </td>
    <td style={{textAlign: "center"}}>
      <img width={128} src="https://i.imgur.com/placeholder7.png" alt="Alligator Egg"/>
      <div style={{marginTop: "6px", fontSize: "14px", opacity: 0.8}}>
        Alligator Egg
      </div>
    </td>
